...
```{r}
copy_to(dest = con, df = recommendations_detailed, overwrite = TRUE, temporary = FALSE)

copy_to(dest = con, 
        df = recommendations_detailed_sample, 
        overwrite = TRUE, 
        temporary = FALSE)
```
...
saveRDS(object = products_rating_matrix, file = "../../App/uap_cross_sell/objects/products_rating_matrix.rds")

saveRDS(object = ke_pop, file = "../../App/uap_cross_sell/objects/ke_pop.rds")

saveRDS(object = product_businesslines, file = "../../App/uap_cross_sell/objects/product_businesslines.rds")

saveRDS(object = unique(recommendations_detailed$ownership), file = "../../App/uap_cross_sell/objects/ownership.rds")

# Project image
save.image(file = "./19Apr_Models.RData")

# Image containing trained model
load("./19Apr_Models.RData")
