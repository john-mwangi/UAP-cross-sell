...
```{r}
ke_recommendations_df <- readRDS(file = "../../../../D - Working Papers/UAP-cross-sell/Models/KE/ke_recommendations_df.rds")
```
...
saveRDS(object = ke_recommendations_detailed, 
        file = "./ke_recommendations_detailed.rds")
...
# Project image
save.image("./22Apr_Customer_details.RData")
