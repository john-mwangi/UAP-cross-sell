...
account_info %>% 
  ...
  mutate(customer_details = glue("Product holding:{product_count}
                                 ...
                                 .na = "Not Found")) %>% 
  select(UNIQUE_ID, ACCOUNT_NO, ownership, intermediated, customer_details)
...
# Project image
save.image("../outputs/17June_Customer_details.RData")
#load("../outputs/17June_Customer_details.RData")
```
