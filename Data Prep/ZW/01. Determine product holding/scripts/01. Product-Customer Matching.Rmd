...
Load product names shared separately by [Farai](https://docs.google.com/spreadsheets/d/1nH-31Fha4YoUTLZ_krU2wBzqDjA9dOUwXM54OlEQU1E/edit#gid=866527667)

```{r}
gi_prod_names <-
read_excel(path = "../../../../../../C - Documentation/Data/festus_extraction/ZW/supp_product_details.xlsx", sheet = "GI")
...
gi_product_holding <-
gi_products_raw %>% 
  left_join(gi_prod_names, by = c("POLICY_TYPE_CODE"="STATUS")) %>% 
...
save.image(file = "../outputs/images/13May.RData")
