...
```{r}
# rownames(products_matrix)[1:28]
colnames(products_matrix)[1:28]
```
...
save.image("./31May_RatingMatrix.RData")
load("./31May_RatingMatrix.RData")
```
