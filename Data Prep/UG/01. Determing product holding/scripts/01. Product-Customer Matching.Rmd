...
```{r}
save.image(file = "./10May-Customer_Matching.RData")
load("10May-Customer_Matching.RData")
```
...
# Project image
save.image(file = "./10May_Product_Cust_Matching.RData")
load("10May_Product_Cust_Matching.RData")
```
